...
export default function SystemSection() {
  return (
    <section 
      ...
      id="das-system"
    >
      <div className="w-full max-w-6xl mx-auto flex flex-col justify-center h-full max-h-[100svh] py-4 md:py-6">
        
        {/* Section Header */}
        <header className="relative z-10 mb-3 md:mb-4 shrink-0">
          <p className="eyebrow mb-1.5 md:mb-3 text-gilt text-[0.66rem] sm:text-[0.72rem]">
            <span className="mr-2.5 tabular-nums opacity-70">08</span>The System
          </p>
          <h2 className="display text-[clamp(1.3rem,2.8vw,2.2rem)] text-bone leading-[1.12]" id="spatial-bento-heading">
            How a presence <span className="display-italic">is put together</span>
          </h2>
          <p className="body-copy mt-1.5 max-w-md text-[0.75rem] sm:text-[0.82rem] md:text-[0.85rem] text-bone/70 hidden sm:block">
            Not a gut feeling, but a system: delivery, weighting, process, and craftsmanship interlock.
          </p>
        </header>

        {/* MOBILE VIEW (< md): Clean 2x2 Bento that fits 100% on one screen */}
        <div className="grid grid-cols-2 gap-2 sm:gap-3 md:hidden w-full max-w-lg mx-auto shrink-0">
          
          {/* Mobile Card 1: Reach */}
          <div className="group relative flex flex-col justify-between rounded-xl p-3 sm:p-3.5 border border-bone/[0.12] bg-gradient-to-b from-bone/[0.07] to-bone/[0.02] shadow-lg backdrop-blur-md">
            <div>
              <p className="eyebrow text-[0.52rem] text-gilt/70">Reach</p>
              <h3 className="display text-[0.88rem] sm:text-[0.95rem] text-bone mt-0.5">Delivered worldwide</h3>
            </div>
          ...
          <div className="group relative flex flex-col justify-between rounded-xl p-3 sm:p-3.5 border border-bone/[0.12] bg-gradient-to-b from-bone/[0.07] to-bone/[0.02] shadow-lg backdrop-blur-md">
            <div>
              <p className="eyebrow text-[0.52rem] text-gilt/70">Process</p>
              <h3 className="display text-[0.88rem] sm:text-[0.95rem] text-bone mt-0.5">Briefing to Launch</h3>
            </div>
            <div className="mt-2.5 flex items-baseline justify-between border-t border-bone/10 pt-2">
          ...
          <div className="group relative flex flex-col justify-between rounded-xl p-3 sm:p-3.5 border border-bone/[0.12] bg-gradient-to-b from-bone/[0.07] to-bone/[0.02] shadow-lg backdrop-blur-md">
            <div>
              ...
              <h3 className="display text-[0.88rem] sm:text-[0.95rem] text-bone mt-0.5">Performance Tested</h3>
            </div>
            <div className="mt-2.5 flex items-baseline justify-between border-t border-bone/10 pt-2">
              <span className="text-[0.66rem] text-bone/60 leading-tight">Framerate &amp; Contrast</span>
              <span className="display text-[0.85rem] text-bone font-medium">100%</span>
            </div>
          </div>

          {/* Mobile Card 4: Attitude */}
          <div className="group relative flex flex-col justify-between rounded-xl p-3 sm:p-3.5 border border-bone/[0.12] bg-gradient-to-b from-bone/[0.07] to-bone/[0.02] shadow-lg backdrop-blur-md">
            <div>
              <p className="eyebrow text-[0.52rem] text-gilt/70">Attitude</p>
              <h3 className="display text-[0.88rem] sm:text-[0.95rem] text-bone mt-0.5">One Single Source</h3>
            </div>
            <div className="mt-2.5 flex items-baseline justify-between border-t border-bone/10 pt-2">
              <span className="text-[0.66rem] text-bone/60 leading-tight">Design &amp; Tech</span>
              <span className="display text-[0.85rem] text-bone font-medium">Integrated</span>
            </div>
          </div>

        </div>

        {/* DESKTOP VIEW (>= md): Full Interactive 3D Bento Grid */}
        <div 
                  ...
                  <div className="group relative flex h-full flex-col gap-2.5 overflow-x-hidden rounded-xl p-4 border border-bone/[0.10] bg-gradient-to-b from-bone/[0.055] via-bone/[0.028] to-bone/[0.012] shadow-[0_18px_50px_-24px_rgba(0,0,0,0.95)] transition-[border-color,box-shadow] duration-500 ease-out hover:border-bone/[0.20] hover:shadow-[0_24px_60px_-24px_rgba(0,0,0,1)] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gilt/70">
                    ...
                    <div className="relative z-10 flex h-full flex-col gap-2">
                      ...
                      <p className="body-copy text-[0.74rem] leading-relaxed">
                        Every page lives at the edges of the network — close to the people who open them.
                      </p>
                      <div className="flex h-full flex-col gap-2">
                        <div className="flex items-baseline justify-end">
                          <span className="display text-[0.95rem] tabular-nums text-bone/85">9 Regions</span>
                        </div>
                        <div className="relative mt-auto w-full max-w-[28rem] self-center overflow-x-hidden">
                          <div aria-hidden="true" className="aspect-[2/1] w-full rounded-md border border-bone/[0.06] bg-[radial-gradient(ellipse_at_50%_45%,rgba(241,241,239,0.05),transparent_70%)]"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative z-10 flex h-full flex-col gap-2">
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <h3 className="display text-[1rem] leading-tight text-bone">Skill Profile</h3>
                        </div>
                      </div>
                      <p className="body-copy text-[0.74rem] leading-relaxed">
                        Where the weight lies in a project — it shifts depending on the type.
                      </p>
                      <div className="flex h-full flex-col">
                        <div aria-hidden="true" className="relative mx-auto aspect-square w-full max-w-[14.5rem]"></div>
                        <p className="mt-2 text-[0.58rem] leading-relaxed text-bone/35">
                          Weighting 0-100 per project type — profile, not measured values.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="h-full" style={{ transformStyle: "preserve-3d" }}>
                  <div className="group relative flex h-full flex-col gap-2.5 overflow-x-hidden rounded-xl p-4 border border-bone/[0.10] bg-gradient-to-b from-bone/[0.055] via-bone/[0.028] to-bone/[0.012] shadow-[0_18px_50px_-24px_rgba(0,0,0,0.95)] transition-[border-color,box-shadow] duration-500 ease-out hover:border-bone/[0.20] hover:shadow-[0_24px_60px_-24px_rgba(0,0,0,1)] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gilt/70">
                    ...
                    <div className="relative z-10 flex h-full flex-col gap-2">
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          <p className="eyebrow mb-1 text-[0.54rem] text-gilt/60">Process</p>
                      ...
                      <ol className="mt-1.5 flex flex-col gap-2">
                        <li className="flex gap-3">
                          ...
                          <span className="min-w-0">
                            <span className="block text-[0.82rem] font-medium text-bone/90">Analysis</span>
                            <span className="block text-[0.7rem] leading-relaxed text-bone/45">Brand, target audience, market, and goals.</span>
                          </span>
                        </li>
                        <li className="flex gap-3">
                          ...
                          <span className="min-w-0">
                            ...
                            <span className="block text-[0.7rem] leading-relaxed text-bone/45">Structure, design direction, user guidance.</span>
                          </span>
                        </li>
                        <li className="flex gap-3">
                          ...
                          <span className="min-w-0">
                            ...
                            <span className="block text-[0.7rem] leading-relaxed text-bone/45">Built high-quality and responsive.</span>
                          </span>
                        </li>
                        <li className="flex gap-3">
                          ...
                          <span className="min-w-0">
                            ...
                            <span className="block text-[0.7rem] leading-relaxed text-bone/45">Publish, test, refine.</span>
                          </span>
                        </li>
                      </ol>
                    </div>
                  ...
                  <div className="group relative flex h-full flex-col gap-2.5 overflow-x-hidden rounded-xl p-4 border border-bone/[0.10] bg-gradient-to-b from-bone/[0.055] via-bone/[0.028] to-bone/[0.012] shadow-[0_18px_50px_-24px_rgba(0,0,0,0.95)] transition-[border-color,box-shadow] duration-500 ease-out hover:border-bone/[0.20] hover:shadow-[0_24px_60px_-24px_rgba(0,0,0,1)] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gilt/70">
                    ...
                    <div className="relative z-10 flex h-full flex-col gap-2">
                      ...
                      <div className="relative flex h-[11.5rem] flex-col">
                        <div className="relative flex-1 overflow-x-hidden" style={{ maskImage: "linear-gradient(to bottom, transparent, black 12%, black 82%, transparent)" }}>
                            ...
                            <li>
                              <div className="flex items-start gap-2.5 rounded-lg border border-bone/[0.07] bg-bone/[0.025] px-3 py-2.5">
                                ...
                                <div className="min-w-0">
                                  ...
                                  <p className="truncate text-[0.66rem] text-bone/45">Camera, lighting, and material per section</p>
                                </div>
                              </div>
                            </li>
                            <li>
                              <div className="flex items-start gap-2.5 rounded-lg border border-bone/[0.07] bg-bone/[0.025] px-3 py-2.5">
                                ...
                                <div className="min-w-0">
                                  <p className="truncate text-[0.74rem] font-medium text-bone/90">Framerate checked</p>
