...
function FaqSection() {
  ...
  return (
    <section aria-labelledby="faq-heading" className="relative flex min-h-[100svh] items-center px-6 py-12 md:px-12 lg:pl-56 xl:pl-64" id="haeufige-fragen">
    ...
    <div className="relative min-h-[100svh] overflow-x-clip bg-ink font-sans text-bone antialiased selection:bg-gilt/30 selection:text-bone">
      ...
      <header className="sticky w-full page-chrome !fixed inset-x-0 top-0 z-[100] pointer-events-auto">
        <div className="relative z-[110] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full lg:flex bg-transparent px-6 py-3 shadow-none dark:bg-transparent" style={{ minWidth: "800px" }}>
          <a className="eyebrow relative z-20 whitespace-nowrap text-bone cursor-pointer" href="#start" style={{ letterSpacing: "0.32em" }} onClick={(e) => { e.preventDefault(); e.stopPropagation(); scrollToSection('start'); }}>SCALE &amp; FORM</a>
          <nav className="relative z-20 hidden flex-1 items-center justify-center gap-7 px-6 md:flex pointer-events-auto">
            <a className="eyebrow relative z-20 whitespace-nowrap px-1 py-2 text-bone/60 transition-colors duration-300 hover:text-bone focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gilt/70 cursor-pointer" href="#was-wir-bauen" onClick={(e) => { e.preventDefault(); e.stopPropagation(); scrollToSection('was-wir-bauen'); }}>Services</a>
            <a className="eyebrow relative z-20 whitespace-nowrap px-1 py-2 text-bone/60 transition-colors duration-300 hover:text-bone focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gilt/70 cursor-pointer" href="#aus-einer-hand" onClick={(e) => { e.preventDefault(); e.stopPropagation(); scrollToSection('aus-einer-hand'); }}>Studio</a>
            <a className="eyebrow relative z-20 whitespace-nowrap px-1 py-2 text-bone/60 transition-colors duration-300 hover:text-bone focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gilt/70 cursor-pointer" href="#vom-briefing-zum-launch" onClick={(e) => { e.preventDefault(); e.stopPropagation(); scrollToSection('vom-briefing-zum-launch'); }}>Process</a>
            <a className="eyebrow relative z-20 whitespace-nowrap px-1 py-2 text-bone/60 transition-colors duration-300 hover:text-bone focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gilt/70 cursor-pointer" href="#founder" onClick={(e) => { e.preventDefault(); e.stopPropagation(); scrollToSection('founder'); }}>Founder</a>
            <a className="eyebrow relative z-20 whitespace-nowrap px-1 py-2 text-bone/60 transition-colors duration-300 hover:text-bone focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gilt/70 cursor-pointer" aria-keyshortcuts="K" href="#projekt-anfragen" onClick={(e) => { e.preventDefault(); e.stopPropagation(); scrollToSection('projekt-anfragen'); }}>Contact</a>
          </nav>
        ...
        <div className="relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center justify-between px-0 py-2 lg:hidden bg-transparent shadow-none dark:bg-transparent">
          <div className="flex w-full flex-row items-center justify-between">
            <a className="eyebrow text-bone" href="#start" style={{"letterSpacing":"0.3em"}} onClick={(e) => { e.preventDefault(); scrollToSection('start'); setIsMobileMenuOpen(false); }}>SCALE &amp; FORM</a>
            <button 
          ...
          {isMobileMenuOpen && (
            <div className="w-full mt-3 rounded-2xl border border-bone/15 bg-ink/95 backdrop-blur-2xl p-6 shadow-2xl">
              <nav className="flex flex-col gap-4">
                {[
                  { id: 'was-wir-bauen', label: 'Services' },
                  { id: 'aus-einer-hand', label: 'Studio' },
                  { id: 'vom-briefing-zum-launch', label: 'Process' },
                  { id: 'founder', label: 'Meet the Founder' },
                  { id: 'haeufige-fragen', label: 'FAQ' },
                  { id: 'das-system', label: 'The System' },
                  { id: 'aktivitaet', label: 'Activity' },
                  { id: 'projekt-anfragen', label: 'Contact' }
                ].map((item) => (
                  <a
                    key={item.id}
                    href={`#${item.id}`}
