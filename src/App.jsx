...
function FaqSection() {
  ...
  return (
    <section aria-labelledby="faq-heading" className="relative flex h-[100svh] min-h-[100svh] max-h-[100svh] items-center px-4 sm:px-6 md:px-12 lg:pl-56 xl:pl-64 overflow-hidden" id="haeufige-fragen">
